    ...
    <section id="historia" className="space-y-10">
      <div>
        ...
        <p className="mt-4 max-w-2xl font-mono tracking-tight text-base text-foreground/70 lg:text-lg">
          un timeline vivo de venues, comunidades y logros; cada evento suma
          aprendizaje colectivo, alianzas y premios para quienes construyen;
        </p>
      </div>
        ...
        {venues.map((venue) => (
          <div key={venue.title} data-scroll-card>
            <div className="flex items-center justify-between">
              ...
              <span className="font-pixel text-lg text-foreground/30">
                {venue.icon}
              </span>
            </div>
